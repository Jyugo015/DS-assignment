...
public class Potions {
    ...
    public TreeMap<String, Potion> initializePotions() {
        ...
        potionsMap.put("Strength Potion I", new Potion("Strength Potion I", 20, "Makes the damage dealt by direct combat higher"));
        potionsMap.put("Strength Potion II", new Potion("Strength Potion II", 50, "Makes the damage dealt by direct combat higher"));
        potionsMap.put("Strength Potion III", new Potion("Strength Potion III", 100, "Makes the damage dealt by direct combat higher"));
        ...
        potionsMap.put("Fire Resistance Potion I", new Potion("Fire Resistance Potion I", 20, "Grants fire resistance"));
        potionsMap.put("Fire Resistance Potion II", new Potion("Fire Resistance Potion II", 50, "Grants fire resistance"));
        potionsMap.put("Fire Resistance Potion III", new Potion("Fire Resistance Potion III", 100, "Grants fire resistance"));
        
        potionsMap.put("Regeneration Potion I", new Potion("Regeneration Potion I", 20, "Regenerates health of the user over time"));
        potionsMap.put("Regeneration Potion II", new Potion("Regeneration Potion II", 50, "Regenerates health of the user over time"));
        potionsMap.put("Regeneration Potion III", new Potion("Regeneration Potion III", 100, "Regenerates health of the user over time"));
        
        potionsMap.put("Water Breathing Potion I", new Potion("Water Breathing Potion I", 20, "Grants ability to breathe underwater"));
        potionsMap.put("Water Breathing Potion II", new Potion("Water Breathing Potion II", 50, "Grants ability to breathe underwater"));
        potionsMap.put("Water Breathing Potion III", new Potion("Water Breathing Potion III", 100, "Grants ability to breathe underwater"));
        ...
        potionsMap.put("Slow Falling Potion III", new Potion("Slow Falling Potion III", 100, "Allow safer descents from high placess"));
        ...
        potionsMap.put("Potion of Luck I", new Potion("Potion of Luck I", 20, "Increases luck for finding rare items"));
        potionsMap.put("Potion of Luck II", new Potion("Potion of Luck II", 50, "Increases luck for finding rare items"));
        potionsMap.put("Potion of Luck III", new Potion("Potion of Luck III", 100, "Increases luck for finding rare items"));
        
        potionsMap.put("Potion of Weakness I", new Potion("Potion of Weakness I", 20, "Decreases the damage dealt by direct combat"));
        potionsMap.put("Potion of Weakness II", new Potion("Potion of Weakness II", 50, "Decreases the damage dealt by direct combats"));
        potionsMap.put("Potion of Weakness III", new Potion("Potion of Weakness III", 100, "Decreases the damage dealt by direct combat"));
